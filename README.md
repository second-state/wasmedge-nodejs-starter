...
[Fork this project](https://github.com/second-state/ssvm-nodejs-starter) to create your own Rust functions in Node.js. [Learn more](https://www.secondstate.io/articles/getting-started-rust-nodejs-vscode/)
